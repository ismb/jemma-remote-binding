...
public class Jemma
{
	...
	enum JemmaMethod
	{
		SYSTEM_LIST_METHODS("system.listMethods"), OSGI_FIND("OSGi.find"), OSGI_BIND(
				"OSGi.bind"), GET_APPLIANCE_CONFIGURATION_DEMO(
						"getApplianceConfigurationDemo"), GET_APPLIANCES_CONFIGURATIONS_DEMO(
								"getAppliancesConfigurationsDemo"),
