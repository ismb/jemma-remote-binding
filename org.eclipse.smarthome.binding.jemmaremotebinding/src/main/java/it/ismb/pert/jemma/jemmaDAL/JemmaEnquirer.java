...
public class JemmaEnquirer {
    ...
    public static final String DEVICE_VALUE_KEY = "device_value";
    public static final String DEVICE_VALUE_NAME_KEY = "name";
    ...
    public void connect(Authenticator jemmaAuthenticator) throws InvalidCredentialsException, IOException {
